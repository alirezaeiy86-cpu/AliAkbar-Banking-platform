...
const TransactionsTable = ({transactions}:TransactionHistoryTableProps) => {
    console.log("transactions is here your can see it", transactions);
  return (
    <div>
      <Table>
        <TableCaption> a listof your transactions</TableCaption>
        ...
        <TableBody>
            {transactions.map((t: Transaction)=>{
                ...
                return(
                    <TableRow key={t.id}
                    className={`${isDebit || amount[0] === "-" ? 'bg-[#FFFBFA]' : 'bg-[#F6FEF9]'} !over:bg-none !border-b`}>
                        ...
                        <TableCell className={`font-semibold ${isDebit || amount[0] === "-" ? 'text-[#f04438] ' : 'text-[#039855]'}`}>
                        ...
                        <TableCell className='max-md:w-[20px]'>
